...
ifeq ($(VERBOSE), 1)
$(info Including:  module-cluster-fsi-config.mk)
endif
...
MODULE_CLUSTER_FSI_CONFIG       := 1

#
# Location of source code files
MODULE_CLUSTER_FSI_SOURCE_DIR    =

#
# Common includes '-I <INCLUDEDIR>'
MODULE_CLUSTER_FSI_INCLUDES      = -I $(FSP_COMMON_REPO)/include/soc/$(SOC)/$(CLUSTER)
