...
ifeq ($(VERBOSE), 1)
$(info Including:  module-cluster-bpmp.mk)
endif
...
MODULE_CLUSTER_BPMP_NAME        := CLUSTER_BPMP
...
#   is called.
CONFIG_CLUSTER_DEPENDS          := CLUSTER_BPMP CLUSTER
$(foreach _,$(CONFIG_CLUSTER_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_CLUSTER_BPMP_C_SRC        =

#
# Assembly source
MODULE_CLUSTER_BPMP_ASM_SRC      =

#
# Special C Flags
MODULE_CLUSTER_BPMP_C_FLAGS      =

#
# Special ASM Flags
MODULE_CLUSTER_BPMP_ASM_FLAGS    =
