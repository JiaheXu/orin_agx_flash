...
#   is called.
CONFIG_OSPL_DEPENDS             := OSPL SOC CPL OSA
$(foreach _,$(CONFIG_OSPL_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_OSPL_C_SRC                =
MODULE_OSPL_C_SRC               += $(OSPL_DIR)/rtos-port-timer.c
MODULE_OSPL_C_SRC               += $(OSPL_DIR)/rtos-port-task.c
