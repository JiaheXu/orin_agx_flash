...
ifeq ($(VERBOSE), 1)
$(info Including:  module-freertos-port-cortex-r5-no-safety-config.mk)
endif
...
MODULE_FREERTOS_PORT_CORTEX_R5_NO_SAFETY_CONFIG     := 1

#
# Location of source code files
MODULE_FREERTOS_PORT_CORTEX_R5_NO_SAFETY_SOURCE_DIR  = $(FREERTOS_PORT_DIR)

#
# Common includes '-I <INCLUDEDIR>'
MODULE_FREERTOS_PORT_CORTEX_R5_NO_SAFETY_INCLUDES   += -I $(FREERTOS_PORT_DIR)
