...
ifeq ($(VERBOSE), 1)
$(info Including:  module-ivclib-nosafety.mk)
endif
...
MODULE_IVCLIB_NOSAFETY_NAME             := IVCLIB_NOSAFETY  
...
#   is called.
CONFIG_IVCLIB_NOSAFETY_DEPENDS          := IVCLIB_NOSAFETY
$(foreach _,$(CONFIG_IVCLIB_NOSAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_IVCLIB_NOSAFETY_C_SRC             =
MODULE_IVCLIB_NOSAFETY_C_SRC            += $(MODULE_IVCLIB_NOSAFETY_DRIVERS_DIR)/tegra-ivc.c
MODULE_IVCLIB_NOSAFETY_C_SRC            += $(MODULE_IVCLIB_NOSAFETY_DRIVERS_DIR)/sivc.c

#
# Special C Flags
MODULE_IVCLIB_NOSAFETY_C_FLAGS           =

#
# Special ASM Flags
MODULE_IVCLIB_NOSAFETY_ASM_FLAGS         =
