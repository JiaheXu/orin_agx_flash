...
ifeq ($(VERBOSE), 1)
$(info Including:  module-watchdog-task.mk)
endif
...
MODULE_WATCHDOG_TASK_NAME       := WATCHDOG_TASK
...
MODULE_WATCHDOG_TASK_DEFINED    := 1
...
#   is called.
CONFIG_WATCHDOG_TASK_DEPENDS    := WATCHDOG_TASK LOGGER_NOSAFETY WDT
$(foreach _,$(CONFIG_WATCHDOG_TASK_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_WATCHDOG_TASK_C_SRC       =
MODULE_WATCHDOG_TASK_C_SRC      += $(MODULE_WATCHDOG_TASK_DRIVERS_DIR)/watchdog-task.c

#
# Assembly source
MODULE_WATCHDOG_TASK_ASM_SRC     =

#
# Special C Flags
MODULE_WATCHDOG_TASK_C_FLAGS     =

#
# Special ASM Flags
MODULE_WATCHDOG_TASK_ASM_FLAGS   =
