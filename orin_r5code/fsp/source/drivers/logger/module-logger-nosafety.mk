...
ifeq ($(VERBOSE), 1)
$(info Including:  module-logger-nosafety.mk)
endif
...
MODULE_LOGGER_NOSAFETY_NAME             := LOGGER_NOSAFETY
...
MODULE_LOGGER_NOSAFETY_DEFINED          := 1
...
#   is called.
CONFIG_LOGGER_NOSAFETY_DEPENDS          := LOGGER_NOSAFETY SOC CPL OSA DEBUG_NOSAFETY TKE
$(foreach _,$(CONFIG_LOGGER_NOSAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_LOGGER_NOSAFETY_C_SRC             =
MODULE_LOGGER_NOSAFETY_C_SRC            += $(LOGGER_DIR)/logger.c

#
# Assembly source
MODULE_LOGGER_NOSAFETY_ASM_SRC           =

#
# Special C Flags
MODULE_LOGGER_NOSAFETY_C_FLAGS           =
ifndef LOG_LEVEL
MODULE_LOGGER_NOSAFETY_C_FLAGS          += -DDEFAULT_LOG_LEVEL=$(DEFAULT_LOG_LEVEL)
endif

#
# Special ASM Flags
MODULE_LOGGER_NOSAFETY_ASM_FLAGS         =
