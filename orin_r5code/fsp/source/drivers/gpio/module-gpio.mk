...
#   is called.
CONFIG_GPIO_DEPENDS             := GPIO SOC CPL
$(foreach _,$(CONFIG_GPIO_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_GPIO_C_SRC                =
MODULE_GPIO_C_SRC               += $(MODULE_GPIO_DRIVERS_DIR)/tegra-gpio.c
MODULE_GPIO_C_SRC               += $(CPL_SOC_IDS)/gpio-tegra-ids.c
ifeq ($(SOC),t234)
    MODULE_GPIO_C_SRC           += $(CPL_SOC_IDS)/gpio-main-tegra-ids.c
    MODULE_GPIO_C_SRC           += $(CPL_SOC_IDS)/gpio-aon-tegra-ids.c
endif
