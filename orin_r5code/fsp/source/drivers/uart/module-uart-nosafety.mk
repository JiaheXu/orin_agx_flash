...
ifeq ($(VERBOSE), 1)
$(info Including:  module-uart-nosafety.mk)
endif
...
MODULE_UART_NOSAFETY_NAME               := UART_NOSAFETY
...
MODULE_UART_NOSAFETY_DEFINED            := 1
...
#   is called.
CONFIG_UART_NOSAFETY_DEPENDS            := UART_NOSAFETY SOC
$(foreach _,$(CONFIG_UART_NOSAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_UART_NOSAFETY_C_SRC               =
MODULE_UART_NOSAFETY_C_SRC              += $(MODULE_UART_NOSAFETY_DRIVERS_DIR)/tegra-uart.c
MODULE_UART_NOSAFETY_C_SRC              += $(FSP_COMMON_REPO)/soc/$(SOC)/ids/soc-common/uart-tegra-ids.c

#
# Assembly source
MODULE_UART_NOSAFETY_ASM_SRC             =

#
# Special C Flags
MODULE_UART_NOSAFETY_C_FLAGS             =

#
# Special ASM Flags
MODULE_UART_NOSAFETY_ASM_FLAGS           =
