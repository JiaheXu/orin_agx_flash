...
ifeq ($(VERBOSE), 1)
$(info Including:  module-watchdog-config.mk)
endif
...
#   is called.
MODULE_WATCHDOG_DEPENDS         :=
$(foreach _,$(MODULE_WATCHDOG_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_WATCHDOG_DRIVERS_DIR      = $(FSP_COMMON_REPO)/drivers/watchdog
MODULE_WATCHDOG_SOURCE_DIR       = $(MODULE_WATCHDOG_DRIVERS_DIR)

#
# Common includes '-I <INCLUDEDIR>'
MODULE_WATCHDOG_INCLUDES         =
