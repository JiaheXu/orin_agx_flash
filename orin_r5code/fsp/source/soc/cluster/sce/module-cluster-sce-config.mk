...
ifeq ($(VERBOSE), 1)
$(info Including:  module-cluster-sce-config.mk)
endif
...
MODULE_CLUSTER_SCE_SOUSCE_DIR    =

#
# Common includes '-I <INCLUDEDIR>'
MODULE_CLUSTER_SCE_INCLUDES      = -I $(FSP_COMMON_REPO)/include/soc/$(SOC)/$(CLUSTER)
