...
ifeq ($(VERBOSE), 1)
$(info Including:  module-fsp-common.mk)
endif
...
MODULE_FSP_COMMON_NAME          := FSP_COMMON
...
#   is called.
CONFIG_FSP_COMMON_DEPENDS       := FSP_COMMON
$(foreach _,$(CONFIG_FSP_COMMON_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_FSP_COMMON_C_SRC          =

#
# Assembly source
MODULE_FSP_COMMON_ASM_SRC        =

#
# Special C Flags
MODULE_FSP_COMMON_C_FLAGS        =

#
# Special ASM Flags
MODULE_FSP_COMMON_ASM_FLAGS      =
