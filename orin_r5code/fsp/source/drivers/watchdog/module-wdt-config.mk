...
ifeq ($(VERBOSE),1)
$(info Including:  module-wdt-config.mk)
endif
...
#   is called.
MODULE_WDT_DEPENDS              :=
$(foreach _,$(MODULE_WDT_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_WDT_DRIVERS_DIR           = $(FSP_COMMON_REPO)/drivers/watchdog
MODULE_WDT_SOURCE_DIR            = $(MODULE_WDT_DRIVERS_DIR)
