...
ifeq ($(VERBOSE), 1)
$(info Including:  module-aodmic-nosafety-config.mk)
endif
...
MODULE_AODMIC_NOSAFETY_CONFIG                := 1
...
#   is called.
MODULE_AODMIC_NOSAFETY_DEPENDS               := SOC CLUSTER CPL GPCDMA
$(foreach _,$(MODULE_AODMIC_NOSAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_AODMIC_NOSAFETY_DRIVERS_DIR            = $(FSP_COMMON_REPO)/drivers/aodmic
MODULE_AODMIC_NOSAFETY_SOURCE_DIR             = $(MODULE_AODMIC_NOSAFETY_DRIVERS_DIR)

#
# Common includes '-I <INCLUDEDIR>'
MODULE_AODMIC_NOSAFETY_INCLUDES               =
