...
ifeq ($(VERBOSE), 1)
$(info Including:  module-spi-mst-config-nosafety.mk)
endif
...
MODULE_SPI_MST_NOSAFETY_CONFIG          := 1
...
#   is called.
MODULE_SPI_MST_NOSAFETY_DEPENDS         := SOC CLUSTER CPL FSP_COMMON
$(foreach _,$(MODULE_SPI_MST_NOSAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_SPI_MST_NOSAFETY_DRIVERS_DIR      = $(FSP_COMMON_REPO)/drivers/spi-mst
MODULE_SPI_MST_NOSAFETY_SOURCE_DIR       = $(MODULE_SPI_MST_NOSAFETY_DRIVERS_DIR)

#
# Common includes '-I <INCLUDEDIR>'
MODULE_SPI_MST_NOSAFETY_INCLUDES         =
