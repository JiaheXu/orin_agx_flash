...
ifeq ($(VERBOSE), 1)
$(info Including:  module-lib-nosafety.mk)
endif
...
MODULE_LIB_NOSAFETY_NAME                := LIB_NOSAFETY
...
#   is called.
CONFIG_LIB_NOSAFETY_DEPENDS             := LIB_NOSAFETY SOC CPL OSA DEBUG_NOSAFETY
$(foreach _,$(CONFIG_LIB_NOSAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_LIB_NOSAFETY_C_SRC                =
MODULE_LIB_NOSAFETY_C_SRC               += $(MODULE_LIB_NOSAFETY_DRIVERS_DIR)/stack-guard.c

#
# Assembly source
MODULE_LIB_NOSAFETY_ASM_SRC              =

#
# Special C Flags
MODULE_LIB_NOSAFETY_C_FLAGS              =

#
# Special ASM Flags
MODULE_LIB_NOSAFETY_ASM_FLAGS            =
