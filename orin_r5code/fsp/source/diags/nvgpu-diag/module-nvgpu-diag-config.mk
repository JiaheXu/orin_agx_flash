...
ifeq ($(VERBOSE), 1)
$(info Including:  module-nvgpu-diag-config.mk)
endif
...
#   is called.
MODULE_NVGPU_DIAG_DEPENDS           := CPL
$(foreach _,$(MODULE_NVGPU_DIAG_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_NVGPU_DIAG_DRIVERS_DIR        = $(FSP_COMMON_REPO)/diags/nvgpu-diag
MODULE_NVGPU_DIAG_SOURCE_DIR         = $(MODULE_NVGPU_DIAG_DRIVERS_DIR)

#
# Common includes '-I <INCLUDEDIR>'
MODULE_NVGPU_DIAG_INCLUDES           =
