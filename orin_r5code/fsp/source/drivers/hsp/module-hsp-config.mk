...
ifeq ($(VERBOSE), 1)
$(info Including:  module-hsp-config.mk)
endif
...
#   is called.
MODULE_HSP_DEPENDS              := SOC CLUSTER CPL OSA FSP_COMMON
$(foreach _,$(MODULE_HSP_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_HSP_DRIVERS_DIR           = $(FSP_COMMON_REPO)/drivers/hsp
MODULE_HSP_SOURCE_DIR            = $(MODULE_HSP_DRIVERS_DIR)
