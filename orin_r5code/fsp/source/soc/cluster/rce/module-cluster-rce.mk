...
ifeq ($(VERBOSE), 1)
$(info Including:  module-cluster-rce.mk)
endif
...
MODULE_CLUSTER_RCE_NAME         := CLUSTER_RCE
...
#   is called.
CONFIG_CLUSTER_DEPENDS          := CLUSTER_RCE CLUSTER
$(foreach _,$(CONFIG_CLUSTER_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_CLUSTER_RCE_C_SRC         =

#
# Assembly source
MODULE_CLUSTER_RCE_ASM_SRC       =

#
# Special C Flags
MODULE_CLUSTER_RCE_C_FLAGS       =

#
# Special ASM Flags
MODULE_CLUSTER_RCE_ASM_FLAGS     =
