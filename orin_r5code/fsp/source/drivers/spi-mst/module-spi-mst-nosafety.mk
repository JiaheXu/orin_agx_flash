...
ifeq ($(VERBOSE), 1)
$(info Including:  module-spi-mst-nosafety.mk)
endif
...
MODULE_SPI_MST_NOSAFETY_NAME            := SPI_MST_NOSAFETY
...
MODULE_SPI_MST_NOSAFETY_DEFINED         := 1
...
#   is called.
CONFIG_SPI_MST_NOSAFETY_DEPENDS         := SPI_MST_NOSAFETY SOC CPL
$(foreach _,$(CONFIG_SPI_MST_NOSAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_SPI_MST_NOSAFETY_C_SRC            =
MODULE_SPI_MST_NOSAFETY_C_SRC           += $(MODULE_SPI_MST_NOSAFETY_DRIVERS_DIR)/spi.c
MODULE_SPI_MST_NOSAFETY_C_SRC           += $(CPL_SOC_IDS)/spi-ids.c

#
# If the client module does not need 'spi-port.c' use this MAKEFILE flag to
# ignore it.
MODULE_SPI_MST_NOSAFETY_C_SRC           += $(CPL_SOC_IDS)/spi-port.c

#
# Assembly source
MODULE_SPI_MST_NOSAFETY_ASM_SRC          =

#
# Special C Flags
MODULE_SPI_MST_NOSAFETY_C_FLAGS          =

#
# Special ASM Flags
MODULE_SPI_MST_NOSAFETY_ASM_FLAGS        =
