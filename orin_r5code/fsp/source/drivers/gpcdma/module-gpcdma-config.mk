...
ifeq ($(VERBOSE), 1)
$(info Including:  module-gpcdma-config.mk)
endif
...
#   is called.
MODULE_GPCDMA_DEPENDS               := SOC CLUSTER CPL
$(foreach _,$(MODULE_GPCDMA_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_GPCDMA_DRIVERS_DIR            = $(FSP_COMMON_REPO)/drivers/gpcdma
MODULE_GPCDMA_SOURCE_DIR             = $(MODULE_GPCDMA_DRIVERS_DIR)

#
# Common includes '-I <INCLUDEDIR>'
MODULE_GPCDMA_INCLUDES               =
