...
#   is called.
CONFIG_AST_DEPENDS              := AST SOC CPL OSA
$(foreach _,$(CONFIG_AST_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_AST_C_SRC                 =
MODULE_AST_C_SRC                += $(MODULE_AST_DRIVERS_DIR)/tegra-ast.c
MODULE_AST_C_SRC                += $(CPL_SOC_IDS)/ast-tegra-ids.c
