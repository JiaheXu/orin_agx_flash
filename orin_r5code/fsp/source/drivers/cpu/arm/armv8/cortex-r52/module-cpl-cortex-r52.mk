...
ifeq ($(VERBOSE), 1)
$(info Including:  module-cpl-cortex-r52.mk)
endif
...
MODULE_CPL_CORTEX_R52_NAME      := CPL_CORTEX_R52
...
#   is called.
CONFIG_CPU_DEPENDS              := CPL CPL_CORTEX_R52
$(foreach _,$(CONFIG_CPU_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_CPL_CORTEX_R52_C_SRC      =

#
# Assembly source
MODULE_CPL_CORTEX_R52_ASM_SRC    =

#
# Special C Flags
MODULE_CPL_CORTEX_R52_C_FLAGS    =

#
# Special ASM Flags
MODULE_CPL_CORTEX_R52_ASM_FLAGS  =
