...
ifeq ($(VERBOSE), 1)
$(info Including:  module-fbdma-config.mk)
endif
...
#   is called.
MODULE_FBDMA_DEPENDS              := CPL FSP_COMMON
$(foreach _,$(MODULE_FBDMA_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_FBDMA_DRIVERS_DIR           = $(FSP_COMMON_REPO)/drivers/fbdma
MODULE_FBDMA_SOURCE_DIR            = $(MODULE_FBDMA_DRIVERS_DIR)

#
# Common includes '-I <INCLUDEDIR>'
MODULE_FBDMA_INCLUDES              =
