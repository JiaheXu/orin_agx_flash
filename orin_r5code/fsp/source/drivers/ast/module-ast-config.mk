...
ifeq ($(VERBOSE), 1)
$(info Including:  module-ast-config.mk)
endif
...
#   is called.
MODULE_AST_DEPENDS              := SOC CLUSTER CPL OSA FSP_COMMON
$(foreach _,$(MODULE_AST_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_AST_DRIVERS_DIR           = $(FSP_COMMON_REPO)/drivers/ast
MODULE_AST_SOURCE_DIR            = $(MODULE_AST_DRIVERS_DIR)
