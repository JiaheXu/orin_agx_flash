...
ifeq ($(VERBOSE), 1)
$(info Including:  module-debug-nosafety.mk)
endif
...
MODULE_DEBUG_NOSAFETY_NAME              := DEBUG_NOSAFETY
...
MODULE_DEBUG_NOSAFETY_DEFINED           := 1
...
#   is called.
CONFIG_DEBUG_NOSAFETY_DEPENDS           := DEBUG_NOSAFETY SOC CPL OSA
$(foreach _,$(CONFIG_DEBUG_NOSAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_DEBUG_NOSAFETY_C_SRC              =
MODULE_DEBUG_NOSAFETY_C_SRC             += $(DEBUG_DIR)/abort.c
MODULE_DEBUG_NOSAFETY_C_SRC             += $(DEBUG_DIR)/assert.c
MODULE_DEBUG_NOSAFETY_C_SRC             += $(DEBUG_DIR)/debug-wait.c

#
# Assembly source
MODULE_DEBUG_NOSAFETY_ASM_SRC            =

#
# Special C Flags
MODULE_DEBUG_NOSAFETY_C_FLAGS            =

#
# Special ASM Flags
MODULE_DEBUG_NOSAFETY_ASM_FLAGS          =
