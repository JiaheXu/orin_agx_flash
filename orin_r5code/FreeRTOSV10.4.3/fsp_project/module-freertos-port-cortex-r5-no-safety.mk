...
ifeq ($(VERBOSE), 1)
$(info Including:  module-freertos-port-cortex-r5-no-safety.mk)
endif
...
MODULE_FREERTOS_PORT_CORTEX_R5_NO_SAFETY_NAME       := FREERTOS_PORT_CORTEX_R5_NO_SAFETY
...
MODULE_FREERTOS_PORT_CORTEX_R5_NO_SAFETY_DEFINED    := 1
...
#   is called.
CONFIG_FREERTOS_PORT_CORTEX_R5_NO_SAFETY_DEPENDS    := FREERTOS_CORE_NO_SAFETY FREERTOS_PORT_CORTEX_R5_NO_SAFETY
$(foreach _,$(CONFIG_FREERTOS_PORT_CORTEX_R5_NO_SAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_FREERTOS_PORT_CORTEX_R5_NO_SAFETY_C_SRC       =
MODULE_FREERTOS_PORT_CORTEX_R5_NO_SAFETY_C_SRC      += $(FREERTOS_PORT_DIR)/port.c

#
# Assembly source
MODULE_FREERTOS_PORT_CORTEX_R5_NO_SAFETY_ASM_SRC     =
MODULE_FREERTOS_PORT_CORTEX_R5_NO_SAFETY_ASM_SRC    += $(FREERTOS_PORT_DIR)/portASM.S

#
# Special C Flags
MODULE_FREERTOS_PORT_CORTEX_R5_NO_SAFETY_C_FLAGS     =

#
# Special ASM Flags
MODULE_FREERTOS_PORT_CORTEX_R5_NO_SAFETY_ASM_FLAGS   =
