...
ifeq ($(VERBOSE), 1)
$(info Including:  module-chipid-config.mk)
endif
...
#   is called.
MODULE_CHIPID_DEPENDS           := SOC CLUSTER CPL OSA FSP_COMMON
$(foreach _,$(MODULE_CHIPID_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_CHIPID_DRIVERS_DIR        = $(FSP_COMMON_REPO)/drivers/chipid
MODULE_CHIPID_SOURCE_DIR         = $(MODULE_CHIPID_DRIVERS_DIR)

#
# Common includes '-I <INCLUDEDIR>'
MODULE_CHIPID_INCLUDES           =
