...
const uint32_t tke_top_base = NV_ADDRESS_MAP_FSI_TKE_BASE;

SECTION_TKE_DATA
struct tegra_tke_id tegra_tke_id_timer0 = {
    .conf = {
        .base_addr = NV_ADDRESS_MAP_FSI_TKE_TMR_0_BASE,
        .irq = NV_FSI_SPI_INTR_BASE + NV_FSI_GIC_TIMER_INTR0,
    },
};
...
struct tegra_tke_id tegra_tke_id_timer1 = {
    .conf = {
        .base_addr = NV_ADDRESS_MAP_FSI_TKE_TMR_1_BASE,
        .irq = NV_FSI_SPI_INTR_BASE + NV_FSI_GIC_TIMER_INTR1,
    },
};
...
struct tegra_tke_id tegra_tke_id_timer2 = {
    .conf = {
        .base_addr = NV_ADDRESS_MAP_FSI_TKE_TMR_2_BASE,
        .irq = NV_FSI_SPI_INTR_BASE + NV_FSI_GIC_TIMER_INTR2,
    },
};
...
struct tegra_tke_id tegra_tke_id_timer3 = {
    .conf = {
        .base_addr = NV_ADDRESS_MAP_FSI_TKE_TMR_3_BASE,
        .irq = NV_FSI_SPI_INTR_BASE + NV_FSI_GIC_TIMER_INTR3,
    },
};
