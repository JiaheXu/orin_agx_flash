...
ifeq ($(VERBOSE), 1)
$(info Including:  module-cluster-dce.mk)
endif
...
MODULE_CLUSTER_DCE_NAME         := CLUSTER_DCE
...
#   is called.
CONFIG_CLUSTER_DEPENDS          := CLUSTER_DCE CLUSTER
$(foreach _,$(CONFIG_CLUSTER_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_CLUSTER_DCE_C_SRC         =

#
# Assembly source
MODULE_CLUSTER_DCE_ASM_SRC       =

#
# Special C Flags
MODULE_CLUSTER_DCE_C_FLAGS       =

#
# Special ASM Flags
MODULE_CLUSTER_DCE_ASM_FLAGS     =
