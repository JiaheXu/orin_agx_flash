...
ifeq ($(VERBOSE), 1)
$(info Including:  module-fsp-common-config.mk)
endif
...
#   is called.
MODULE_FSP_COMMON_DEPENDS       :=
$(foreach _,$(MODULE_FSP_COMMON_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
FSP_COMMON_INCLUDE               = $(FSP_COMMON_REPO)/include
MODULE_FSP_COMMON_SOURCE_DIR     =

#
# Common includes '-I <INCLUDEDIR>'
MODULE_FSP_COMMON_INCLUDES       = -I $(FSP_COMMON_INCLUDE)
