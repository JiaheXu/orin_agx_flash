...
ifeq ($(VERBOSE), 1)
$(info Including:  module-cluster-aon.mk)
endif
...
MODULE_CLUSTER_AON_NAME         := CLUSTER_AON
...
#   is called.
CONFIG_CLUSTER_DEPENDS          := CLUSTER_AON CLUSTER
$(foreach _,$(CONFIG_CLUSTER_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_CLUSTER_AON_C_SRC        =

#
# Assembly source
MODULE_CLUSTER_AON_ASM_SRC      =

#
# Special C Flags
MODULE_CLUSTER_AON_C_FLAGS      = -DTEGRA_UARTC_ENABLED

#
# Special ASM Flags
MODULE_CLUSTER_AON_ASM_FLAGS    =
