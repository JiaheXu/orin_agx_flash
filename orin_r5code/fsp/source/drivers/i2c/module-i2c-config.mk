...
ifeq ($(VERBOSE), 1)
$(info Including:  module-i2c-config.mk)
endif
...
#   is called.
MODULE_I2C_DEPENDS              := SOC CLUSTER CPL OSA FSP_COMMON
$(foreach _,$(MODULE_I2C_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_I2C_DRIVERS_DIR           = $(FSP_COMMON_REPO)/drivers/i2c
MODULE_I2C_SOURCE_DIR            = $(MODULE_I2C_DRIVERS_DIR)
