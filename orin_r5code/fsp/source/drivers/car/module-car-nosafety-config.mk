...
ifeq ($(VERBOSE), 1)
$(info Including:  module-car-nosafety-config.mk)
endif
...
#   is called.
MODULE_CAR_NOSAFETY_DEPENDS             := SOC CLUSTER CPL OSA FSP_COMMON
$(foreach _,$(MODULE_CAR_NOSAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_CAR_NOSAFETY_DRIVERS_DIR		     = $(FSP_COMMON_REPO)/drivers/car
MODULE_CAR_NOSAFETY_SOURCE_DIR		     = $(MODULE_CAR_NOSAFETY_DRIVERS_DIR)

#
# Common includes '-I <INCLUDEDIR>'
MODULE_CAR_NOSAFETY_INCLUDES             =
