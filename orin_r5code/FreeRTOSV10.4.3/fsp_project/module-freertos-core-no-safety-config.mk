...
ifeq ($(VERBOSE), 1)
$(info Including:  module-freertos-core-no-safety-config.mk)
endif
...
MODULE_FREERTOS_CORE_NO_SAFETY_CONFIG               := 1

#
# Location of source code files
MODULE_FREERTOS_CORE_NO_SAFETY_SOURCE_DIR            = $(FREERTOS_DIR)

#
# Common includes '-I <INCLUDEDIR>'
MODULE_FREERTOS_CORE_NO_SAFETY_INCLUDES              =
MODULE_FREERTOS_CORE_NO_SAFETY_INCLUDES              = -I $(FREERTOS_DIR)/include
