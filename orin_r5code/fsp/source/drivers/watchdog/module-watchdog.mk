...
ifeq ($(VERBOSE), 1)
$(info Including:  module-watchdog.mk)
endif
...
#   is called.
CONFIG_WATCHDOG_DEPENDS         := WATCHDOG SOC CPL OSA DEBUG_NOSAFETY TKE
$(foreach _,$(CONFIG_WATCHDOG_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_WATCHDOG_C_SRC            =
MODULE_WATCHDOG_C_SRC           += $(MODULE_WATCHDOG_DRIVERS_DIR)/watchdog.c

#
# Assembly source
MODULE_WATCHDOG_ASM_SRC          =

#
# Special C Flags
MODULE_WATCHDOG_C_FLAGS          =

#
# Special ASM Flags
MODULE_WATCHDOG_ASM_FLAGS        =
