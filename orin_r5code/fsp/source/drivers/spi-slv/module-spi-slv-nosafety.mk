...
ifeq ($(VERBOSE), 1)
$(info Including:  module-spi-slv-nosafety.mk)
endif
...
MODULE_SPI_SLV_NOSAFETY_NAME            := SPI_SLV_NOSAFETY
...
MODULE_SPI_SLV_NOSAFETY_DEFINED         := 1
...
#   is called.
CONFIG_SPI_SLV_NOSAFETY_DEPENDS         := SPI_SLV_NOSAFETY SOC CPL
$(foreach _,$(CONFIG_SPI_SLV_NOSAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_SPI_SLV_NOSAFETY_C_SRC            =
MODULE_SPI_SLV_NOSAFETY_C_SRC           += $(MODULE_SPI_SLV_NOSAFETY_DRIVERS_DIR)/spi-slave.c
MODULE_SPI_SLV_NOSAFETY_C_SRC           += $(CPL_SOC_IDS)/spi-ids.c

#
# If the client module does not need 'spi-port.c' use this MAKEFILE flag to
# ignore it.
ifndef IGNORE_SPI_PORT
MODULE_SPI_SLV_NOSAFETY_C_SRC           += $(CPL_SOC_PORT)/spi-port.c
endif

#
# Assembly source
MODULE_SPI_SLV_NOSAFETY_ASM_SRC          =
#MODULE_SPI_SLV_NOSAFETY_ASM_SRC        += $(CPL_SOC_PORT)/spi-irq.S

#
# Special C Flags
MODULE_SPI_SLV_NOSAFETY_C_FLAGS          =

#
# Special ASM Flags
MODULE_SPI_SLV_NOSAFETY_ASM_FLAGS        =
