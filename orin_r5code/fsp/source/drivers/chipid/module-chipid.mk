...
ifeq ($(VERBOSE), 1)
$(info Including:  module-chipid.mk)
endif
...
#   is called.
CONFIG_CHIPID_DEPENDS           := CHIPID SOC
$(foreach _,$(CONFIG_CHIPID_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_CHIPID_C_SRC              =
MODULE_CHIPID_C_SRC             += $(MODULE_CHIPID_DRIVERS_DIR)/chip-id.c

#
# Assembly source
MODULE_CHIPID_ASM_SRC            =

#
# Special C Flags
MODULE_CHIPID_C_FLAGS            =

#
# Special ASM Flags
MODULE_CHIPID_ASM_FLAGS          =
