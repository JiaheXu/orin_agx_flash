...
ifeq ($(VERBOSE), 1)
$(info Including:  module-debug-nosafety-config.mk)
endif
...
MODULE_DEBUG_NOSAFETY_CONFIG            := 1
...
#   is called.
MODULE_DEBUG_NOSAFETY_DEPENDS           := SOC CLUSTER CPL OSA FSP_COMMON
$(foreach _,$(MODULE_DEBUG_NOSAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
DEBUG_DIR                                = $(FSP_COMMON_REPO)/drivers/debug
MODULE_DEBUG_NOSAFETY_SOURCE_DIR         = $(DEBUG_DIR)

#
# Common includes '-I <INCLUDEDIR>'
MODULE_DEBUG_NOSAFETY_INCLUDES           =
