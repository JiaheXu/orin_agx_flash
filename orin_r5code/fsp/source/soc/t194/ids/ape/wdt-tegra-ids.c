...
CT_ASSERT(FSP__SECTIONS__SECTIONS_H, "Header file missing or invalid.")
...
struct tegra_wdt tegra_wdt_instance = {
    .id = {
        .devname        = "wdt",
        .base_addr      = NV_ADDRESS_MAP_APE_TKE_WDT_0_BASE,
        .irq            = NV_APE_IRQ_WDTIRQ,
        .fiq            = NV_APE_IRQ_WDTFIQ,
    },
};
