...
ifeq ($(VERBOSE), 1)
$(info Including:  module-adcc-nosafety-config.mk)
endif
...
#   is called.
MODULE_ADCC_NOSAFETY_DEPENDS       := SOC CLUSTER CPL OSA FSP_COMMON
$(foreach _,$(MODULE_ADCC_NOSAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_ADCC_NOSAFETY_SOURCE_DIR     = $(FSP_COMMON_REPO)/drivers/adcc

#
# Common includes '-I <INCLUDEDIR>'
MODULE_ADCC_NOSAFETY_INCLUDES       =
