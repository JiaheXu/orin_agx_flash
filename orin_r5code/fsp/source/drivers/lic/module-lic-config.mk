...
ifeq ($(VERBOSE), 1)
$(info Including:  module-lic-config.mk)
endif
...
#   is called.
MODULE_LIC_DEPENDS              := SOC CLUSTER CPL
$(foreach _,$(MODULE_LIC_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_LIC_DRIVERS_DIR           = $(FSP_COMMON_REPO)/drivers/lic
MODULE_LIC_SOURCE_DIR            = $(MODULE_LIC_DRIVERS_DIR)
