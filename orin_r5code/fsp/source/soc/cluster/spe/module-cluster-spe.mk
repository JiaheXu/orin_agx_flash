...
ifeq ($(VERBOSE), 1)
$(info Including:  module-cluster-spe.mk)
endif
...
MODULE_CLUSTER_SPE_NAME         := CLUSTER_SPE
...
#   is called.
CONFIG_CLUSTER_DEPENDS          := CLUSTER_SPE CLUSTER
$(foreach _,$(CONFIG_CLUSTER_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_CLUSTER_SPE_C_SRC         =

#
# Assembly source
MODULE_CLUSTER_SPE_ASM_SRC       =

#
# Special C Flags
MODULE_CLUSTER_SPE_C_FLAGS       =

#
# Special ASM Flags
MODULE_CLUSTER_SPE_ASM_FLAGS     =
