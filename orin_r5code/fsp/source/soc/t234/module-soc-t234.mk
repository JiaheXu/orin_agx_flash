...
ifeq ($(VERBOSE), 1)
$(info Including:  module-soc-t234.mk)
endif
...
#   is called.
CONFIG_SOC_DEPENDS              := SOC SOC_T234
$(foreach _,$(CONFIG_SOC_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_SOC_T234_C_SRC            =
MODULE_SOC_T234_C_SRC           += $(CPL_SOC_IDS_CMN)/clk-tegra.c

#
# Assembly source
MODULE_SOC_T234_ASM_SRC          =

#
# Special C Flags
MODULE_SOC_T234_C_FLAGS          =

#
# Special ASM Flags
MODULE_SOC_T234_ASM_FLAGS        =
