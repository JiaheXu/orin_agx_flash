...
ifeq ($(VERBOSE), 1)
$(info Including:  module-osa-config.mk)
endif
...
#   is called.
MODULE_OSA_DEPENDS              := SOC CLUSTER CPL
$(foreach _,$(MODULE_OSA_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_OSA_SOURCE_DIR            =

#
# Common includes '-I <INCLUDEDIR>'
MODULE_OSA_INCLUDES              = -I $(FSP_COMMON_REPO)/include/osa/$(OSA)
