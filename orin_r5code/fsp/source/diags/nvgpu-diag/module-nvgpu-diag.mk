...
ifeq ($(VERBOSE), 1)
$(info Including:  module-nvgpu-diag.mk)
endif
...
MODULE_NVGPU_DIAG_NAME          := NVGPU_DIAG
...
#   is called.
CONFIG_NVGPU_DIAG_DEPENDS       := NVGPU_DIAG CPL
$(foreach _,$(CONFIG_NVGPU_DIAG_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_NVGPU_DIAG_C_SRC          =
MODULE_NVGPU_DIAG_C_SRC         += $(MODULE_NVGPU_DIAG_DRIVERS_DIR)/nvgpu-diag.c

#
# Assembly source
MODULE_NVGPU_DIAG_ASM_SRC        =

#
# Special C Flags
MODULE_NVGPU_DIAG_C_FLAGS        =

#
# Special ASM Flags
MODULE_NVGPU_DIAG_ASM_FLAGS      =
