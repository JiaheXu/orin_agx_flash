...
ifeq ($(VERBOSE), 1)
$(info Including:  module-datasizes-nosafety.mk)
endif
...
MODULE_DATASIZES_NOSAFETY_NAME          := DATASIZES_NOSAFETY
...
MODULE_DATASIZES_NOSAFETY_DEFINED       := 1
...
#   is called.
CONFIG_DATASIZES_NOSAFETY_DEPENDS       := DATASIZES_NOSAFETY
$(foreach _,$(CONFIG_DATASIZES_NOSAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_DATASIZES_NOSAFETY_C_SRC          =
MODULE_DATASIZES_NOSAFETY_C_SRC         += $(DATASIZES_DIR)/datasizes.c

#
# Assembly source
MODULE_DATASIZES_NOSAFETY_ASM_SRC        =

#
# Special C Flags
MODULE_DATASIZES_NOSAFETY_C_FLAGS        =

#
# Special ASM Flags
MODULE_DATASIZES_NOSAFETY_ASM_FLAGS      =
