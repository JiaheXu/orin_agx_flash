...
ifeq ($(VERBOSE), 1)
$(info Including:  module-comb-uart-nosafety-config.mk)
endif
...
MODULE_COMB_UART_NOSAFETY_CONFIG        := 1
...
#   is called.
MODULE_COMB_UART_NOSAFETY_DEPENDS       := SOC CLUSTER CPL FSP_COMMON
$(foreach _,$(MODULE_COMB_UART_NOSAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_COMB_UART_NOSAFETY_SOURCE_DIR     = $(FSP_COMMON_REPO)/drivers/comb-uart

#
# Common includes '-I <INCLUDEDIR>'
MODULE_COMB_UART_NOSAFETY_INCLUDES       =
