...
ifeq ($(VERBOSE), 1)
$(info Including:  module-cluster-spe-config.mk)
endif
...
MODULE_CLUSTER_SPE_SOURCE_DIR        =

#
# Common includes '-I <INCLUDEDIR>'
MODULE_CLUSTER_SPE_INCLUDES          = -I $(FSP_COMMON_REPO)/include/soc/$(SOC)/$(CLUSTER)
