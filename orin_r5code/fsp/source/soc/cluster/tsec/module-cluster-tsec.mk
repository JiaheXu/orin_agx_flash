...
ifeq ($(VERBOSE), 1)
$(info Including:  module-cluster-tsec.mk)
endif
...
MODULE_CLUSTER_TSEC_NAME        := CLUSTER_TSEC
...
#   is called.
CONFIG_CLUSTER_DEPENDS          := CLUSTER_TSEC CLUSTER
$(foreach _,$(CONFIG_CLUSTER_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_CLUSTER_TSEC_C_SRC        =

#
# Assembly source
MODULE_CLUSTER_TSEC_ASM_SRC      =

#
# Special C Flags
MODULE_CLUSTER_TSEC_C_FLAGS      =

#
# Special ASM Flags
MODULE_CLUSTER_TSEC_ASM_FLAGS    =
