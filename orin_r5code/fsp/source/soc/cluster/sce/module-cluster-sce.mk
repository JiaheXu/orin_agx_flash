...
ifeq ($(VERBOSE), 1)
$(info Including:  module-cluster-sce.mk)
endif
...
MODULE_CLUSTER_SCE_NAME         := CLUSTER_SCE
...
#   is called.
CONFIG_CLUSTER_DEPENDS          := CLUSTER_SCE CLUSTER
$(foreach _,$(CONFIG_CLUSTER_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_CLUSTER_SCE_C_SRC         =

#
# Assembly source
MODULE_CLUSTER_SCE_ASM_SRC       =

#
# Special C Flags
MODULE_CLUSTER_SCE_C_FLAGS       =

#
# Special ASM Flags
MODULE_CLUSTER_SCE_ASM_FLAGS     =
