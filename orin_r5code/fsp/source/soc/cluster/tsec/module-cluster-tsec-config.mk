...
ifeq ($(VERBOSE), 1)
$(info Including:  module-cluster-tsec-config.mk)
endif
...
MODULE_CLUSTER_TSEC_CONFIG          := 1

#
# Location of source code files
MODULE_CLUSTER_TSEC_SOURCE_DIR       =

#
# Common includes '-I <INCLUDEDIR>'
MODULE_CLUSTER_TSEC_INCLUDES         = -I $(FSP_COMMON_REPO)/include/soc/$(SOC)/$(CLUSTER)
