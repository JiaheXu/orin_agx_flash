...
ifeq ($(VERBOSE), 1)
$(info Including:  module-soc-t194.mk)
endif
...
#   is called.
CONFIG_SOC_DEPENDS              := SOC SOC_T194
$(foreach _,$(CONFIG_SOC_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_SOC_T194_C_SRC            =
MODULE_SOC_T194_C_SRC           += $(CPL_SOC_IDS_CMN)/clk-tegra.c

#
# Assembly source
MODULE_SOC_T194_ASM_SRC          =

#
# Special C Flags
MODULE_SOC_T194_C_FLAGS          =

#
# Special ASM Flags
MODULE_SOC_T194_ASM_FLAGS        =
