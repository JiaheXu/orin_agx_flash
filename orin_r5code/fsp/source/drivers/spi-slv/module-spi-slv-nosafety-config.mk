...
ifeq ($(VERBOSE), 1)
$(info Including:  module-spi-slv-nosafety-config.mk)
endif
...
MODULE_SPI_SLV_NOSAFETY_CONFIG          := 1
...
#   is called.
MODULE_SPI_SLV_NOSAFETY_DEPENDS         := SOC CLUSTER CPL FSP_COMMON
$(foreach _,$(MODULE_SPI_SLV_NOSAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_SPI_SLV_NOSAFETY_DRIVERS_DIR      = $(FSP_COMMON_REPO)/drivers/spi-slv
MODULE_SPI_SLV_NOSAFETY_SOURCE_DIR       = $(MODULE_SPI_SLV_NOSAFETY_DRIVERS_DIR)

#
# Common includes '-I <INCLUDEDIR>'
MODULE_SPI_SLV_NOSAFETY_INCLUDES         =
