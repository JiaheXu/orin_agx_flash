...
ifeq ($(VERBOSE), 1)
$(info Including:  module-cluster-aon-config.mk)
endif
...
MODULE_CLUSTER_AON_SOURCE_DIR    =

#
# Common includes '-I <INCLUDEDIR>'
MODULE_CLUSTER_AON_INCLUDES      = -I $(FSP_COMMON_REPO)/include/soc/$(SOC)/$(CLUSTER)
