...
ifeq ($(VERBOSE), 1)
$(info Including:  module-datasizes-config.mk)
endif
...
MODULE_DATASIZES_NOSAFETY_CONFIG        := 1
...
#   is called.
MODULE_DATASIZES_NOSAFETY_DEPENDS       :=
$(foreach _,$(MODULE_DATASIZES_NOSAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
DATASIZES_DIR                            = $(FSP_COMMON_REPO)/drivers/debug
MODULE_DATASIZES_NOSAFETY_SOURCE_DIR     = $(DATASIZES_DIR)

#
# Common includes '-I <INCLUDEDIR>'
MODULE_DATASIZES_NOSAFETY_INCLUDES       =
