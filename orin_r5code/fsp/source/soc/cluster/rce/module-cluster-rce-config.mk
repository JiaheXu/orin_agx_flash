...
ifeq ($(VERBOSE), 1)
$(info Including:  module-cluster-rce-config.mk)
endif
...
MODULE_CLUSTER_RCE_SOURCE_DIR    =

#
# Common includes '-I <INCLUDEDIR>'
MODULE_CLUSTER_RCE_INCLUDES      = -I $(FSP_COMMON_REPO)/include/soc/$(SOC)/$(CLUSTER)
