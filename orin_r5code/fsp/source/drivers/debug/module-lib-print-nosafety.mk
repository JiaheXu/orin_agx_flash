...
ifeq ($(VERBOSE), 1)
$(info Including:  module-lib-print-nosafety.mk)
endif
...
MODULE_LIB_PRINT_NOSAFETY_NAME          := LIB_PRINT
...
MODULE_LIB_PRINT_NOSAFETY_DEFINED       := 1
...
#   is called.
CONFIG_LIB_PRINT_NOSAFETY_DEPENDS       := LIB_PRINT_NOSAFETY SOC
$(foreach _,$(CONFIG_LIB_PRINT_NOSAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_LIB_PRINT_NOSAFETY_C_SRC          =
MODULE_LIB_PRINT_NOSAFETY_C_SRC         += $(LIB_PRINT_DIR)/debug.c
MODULE_LIB_PRINT_NOSAFETY_C_SRC         += $(LIB_PRINT_DIR)/print.c
MODULE_LIB_PRINT_NOSAFETY_C_SRC         += $(LIB_PRINT_DIR)/retarget-stdio.c

#
# Assembly source
MODULE_LIB_PRINT_NOSAFETY_ASM_SRC        =

#
# Special C Flags
MODULE_LIB_PRINT_NOSAFETY_C_FLAGS        =

#
# Special ASM Flags
MODULE_LIB_PRINT_NOSAFETY_ASM_FLAGS      =
