...
ifeq ($(VERBOSE), 1)
$(info Including:  module-watchdog-statistics-config.mk)
endif
...
MODULE_WATCHDOG_STATISTICS_CONFIG       := 1
...
#   is called.
MODULE_WATCHDOG_STATISTICS_DEPENDS      :=
$(foreach _,$(MODULE_WATCHDOG_STATISTICS_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_WATCHDOG_STATISTICS_DRIVERS_DIR   = $(FSP_COMMON_REPO)/drivers/watchdog
MODULE_WATCHDOG_STATISTICS_SOURCE_DIR    = $(MODULE_WATCHDOG_STATISTICS_DRIVERS_DIR)

#
# Common includes '-I <INCLUDEDIR>'
MODULE_WATCHDOG_STATISTICS_INCLUDES      =
