...
#   is called.
CONFIG_WDT_DEPENDS              := WDT SOC CPL OSA
$(foreach _,$(CONFIG_WDT_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_WDT_C_SRC                 =
MODULE_WDT_C_SRC                += $(MODULE_WDT_DRIVERS_DIR)/wdt-tegra.c
MODULE_WDT_C_SRC                += $(CPL_SOC_IDS)/wdt-tegra-ids.c

#
# Assembly source
MODULE_WDT_ASM_SRC               =
MODULE_WDT_ASM_SRC              += $(CPL_SOC_PORT)/wdt-irq.S
