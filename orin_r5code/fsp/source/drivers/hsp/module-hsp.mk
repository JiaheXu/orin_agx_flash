...
#   is called.
CONFIG_HSP_DEPENDS              := HSP SOC CPL OSA
$(foreach _,$(CONFIG_HSP_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_HSP_C_SRC                 =
MODULE_HSP_C_SRC                += $(MODULE_HSP_DRIVERS_DIR)/hsp-tegra.c
MODULE_HSP_C_SRC                += $(CPL_SOC_IDS)/hsp-tegra-ids.c
ifeq ($(SOC), t194)
MODULE_HSP_C_SRC                += $(MODULE_HSP_DRIVERS_DIR)/hsp-tegra-dummy-isr-sm-128.c
else
MODULE_HSP_C_SRC                += $(MODULE_HSP_DRIVERS_DIR)/hsp-tegra-sm-128.c
endif

#
# Assembly source
MODULE_HSP_ASM_SRC               =
MODULE_HSP_ASM_SRC              += $(CPL_SOC_PORT)/hsp-irq.S
