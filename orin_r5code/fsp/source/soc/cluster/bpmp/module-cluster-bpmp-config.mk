...
ifeq ($(VERBOSE), 1)
$(info Including:  module-cluster-bpmp-config.mk)
endif
...
MODULE_CLUSTER_BPMP_SOURCE_DIR   =

#
# Common includes '-I <INCLUDEDIR>'
MODULE_CLUSTER_BPMP_INCLUDES     = -I $(FSP_COMMON_REPO)/include/soc/$(SOC)/$(CLUSTER)
