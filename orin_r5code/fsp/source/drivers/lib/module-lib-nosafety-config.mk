...
ifeq ($(VERBOSE), 1)
$(info Including:  module-lib-config-nosafety.mk)
endif
...
#   is called.
MODULE_LIB_NOSAFETY_DEPENDS             := SOC CLUSTER CPL OSA FSP_COMMON
$(foreach _,$(MODULE_LIB_NOSAFETY_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# Location of source code files
MODULE_LIB_NOSAFETY_DRIVERS_DIR          = $(FSP_COMMON_REPO)/drivers/lib
MODULE_LIB_NOSAFETY_SOURCE_DIR           = $(MODULE_LIB_NOSAFETY_DRIVERS_DIR)

#
# Common includes '-I <INCLUDEDIR>'
MODULE_LIB_NOSAFETY_INCLUDES             =
