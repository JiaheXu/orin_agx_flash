...
ifeq ($(VERBOSE), 1)
$(info Including:  module-cr52-diag.mk)
endif
...
MODULE_CR52_DIAG_NAME		:= CR52_DIAG
...
#   is called.
CONFIG_CR52_DIAG_DEPENDS	:= CR52_DIAG CPL
$(foreach _,$(CONFIG_CR52_DIAG_DEPENDS),$(eval $(call CHECK_MAKEFILE_DEFINED,$_)))

#
# C Source
MODULE_CR52_DIAG_C_SRC		 =
MODULE_CR52_DIAG_C_SRC		+= $(MODULE_CR52_DIAG_DRIVERS_DIR)/cr52-diag.c

#
# Assembly source
MODULE_CR52_DIAG_ASM_SRC	 =

#
# Special C Flags
MODULE_CR52_DIAG_C_FLAGS	 =

#
# Special ASM Flags
MODULE_CR52_DIAG_ASM_FLAGS	 =
